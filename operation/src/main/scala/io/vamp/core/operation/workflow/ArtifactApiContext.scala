...
class ArtifactApiContext(group: String, val persistenceActor: ActorRef)(implicit scheduledWorkflow: ScheduledWorkflow, ec: ExecutionContext, arf: ActorRefFactory) extends ApiContext with ArtifactApiController {
